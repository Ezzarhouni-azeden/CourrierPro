...
public class UtilisateurController {
    ...
    public ResponseEntity<UserDTO> getUtilisateurById(
        ...
        Optional<UserDTO> utilisateurDTO = utilisateurService.getUtilisateurById(id);
    ...
    public ResponseEntity<UserDTO> addUtilisateur(
        ...
        UserDTO newUtilisateurDTO = utilisateurService.addUtilisateur(utilisateurDTO);
    ...
    public ResponseEntity<UserDTO> updateUtilisateur(
            ...
            @RequestBody UserDTO utilisateurDTO) {
        UserDTO updatedUtilisateurDTO = utilisateurService.updateUtilisateur(id, utilisateurDTO);
